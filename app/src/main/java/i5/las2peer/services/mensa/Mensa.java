...
public class Mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "308", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-308/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getDishRatings(@PathParam("id") String id) {
    ...
    if(dish_not_found_condition) {
      JSONObject dish_not_found = new classes().new Dish Rating().toJSON();
